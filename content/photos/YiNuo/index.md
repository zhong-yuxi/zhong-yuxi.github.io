...
<div class="masonry-gallery">
  {{< oriented-image src="yinuo1.jpeg" alt="Yinuo 1" loading="lazy" process="resize 800x webp" >}}
  ...
  {{< oriented-image src="yinuo4.JPG" alt="Yinuo 4" loading="lazy" process="resize 800x webp" >}}
  ...
  {{< oriented-image src="yinuo8.JPG" alt="Yinuo 8" loading="lazy" process="resize 800x webp" >}}
  ...
  {{< oriented-image src="yinuo24.jpeg" alt="Yinuo 24" loading="lazy" process="resize 800x webp" >}}
  {{< oriented-image src="yinuo25.jpeg" alt="Yinuo 25" loading="lazy" process="resize 800x webp" >}}
