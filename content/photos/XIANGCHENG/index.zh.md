...
draft: false
weight: 3
gallery_preview: false
---

<link rel="stylesheet" href="/css/xiangcheng-book.css?v=2">

<div class="xiangcheng-book-shell" data-xiangcheng-book data-spread-label="摄影书跨页">
<div class="xiangcheng-book-navigation">
<button class="xiangcheng-book-arrow xiangcheng-book-arrow--previous is-hidden" type="button" aria-label="上一跨页" aria-hidden="true" tabindex="-1">
<i class="bi bi-arrow-left" aria-hidden="true"></i>
</button>

<div class="xiangcheng-book-stage" aria-label="摄影书跨页 1 / 12">
...
<button class="xiangcheng-book-arrow xiangcheng-book-arrow--next" type="button" aria-label="下一跨页">
<i class="bi bi-arrow-right" aria-hidden="true"></i>
</button>
</div>

<div class="xiangcheng-spread-indicator" aria-hidden="true"></div>
</div>

<dialog class="xiangcheng-lightbox" aria-label="照片查看器">
<button class="xiangcheng-lightbox__close" type="button" aria-label="关闭照片查看器">
<i class="bi bi-x-lg" aria-hidden="true"></i>
</button>
<button class="xiangcheng-lightbox__nav xiangcheng-lightbox__nav--previous" type="button" aria-label="上一张照片">
<i class="bi bi-arrow-left" aria-hidden="true"></i>
</button>
<figure class="xiangcheng-lightbox__figure">
<img class="xiangcheng-lightbox__image" src="" alt="">
<figcaption class="xiangcheng-lightbox__caption">
<span class="xiangcheng-lightbox__index"></span>
<span class="xiangcheng-lightbox__location"></span>
<span class="xiangcheng-lightbox__description"></span>
</figcaption>
</figure>
<button class="xiangcheng-lightbox__nav xiangcheng-lightbox__nav--next" type="button" aria-label="下一张照片">
<i class="bi bi-arrow-right" aria-hidden="true"></i>
</button>
</dialog>

<script src="/js/page-flip.browser.js?v=2"></script>
<script src="/js/xiangcheng-book.js?v=1"></script>
