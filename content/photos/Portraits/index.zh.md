...
<section class="making-wall" data-making-gallery>
  ...
  <div class="making-installation">
    ...
    <div class="making-grid" data-making-grid>
      ...
      {{< making-photo src="making06.jpeg" description="割石头" hang="98" tilt="-1" >}}
      {{< making-photo src="making07.jpeg" description="处理桃树枝" hang="168" tilt="0.4" >}}
      {{< making-photo src="making08.jpeg" description="画底稿" hang="126" tilt="-0.7" >}}
      {{< making-photo src="making09.jpeg" description="上白底" hang="102" tilt="0.5" >}}
  ...
  <dialog class="making-lightbox" aria-label="照片浏览器">
    ...
    <button class="making-lightbox-arrow" type="button" data-direction="next" aria-label="下一张">›</button>
  </dialog>
</section>
