<div id="stage-1" class="container-fluid px-0 text-center my-5 breakout-width">
  ...
  <div class="row justify-content-center g-4">
    <div class="col-12 col-md-4">
      <!-- 后缀修改：stove1.jpg -> stove1.webp -->
      <img src="stove1.webp" class="img-fluid w-100 rounded-2 shadow stove-option" onclick="enterStage2('stove1.webp')" alt="Stove 1">
    </div>
    <div class="col-12 col-md-4">
      <!-- 后缀修改：stove2.jpg -> stove2.webp -->
      <img src="stove2.webp" class="img-fluid w-100 rounded-2 shadow stove-option" onclick="enterStage2('stove2.webp')" alt="Stove 2">
    </div>
    <div class="col-12 col-md-4">
      <!-- 后缀修改：stove3.jpg -> stove3.webp -->
      <img src="stove3.webp" class="img-fluid w-100 rounded-2 shadow stove-option" onclick="enterStage2('stove3.webp')" alt="Stove 3">
    </div>
  </div>
</div>
...
<script>
// 1. 数据图库：后缀已全部更新为 .webp
const detailData = {
'cat': { title: "Stove Cat", images: ["cat1.webp", "cat2.webp", "cat3.webp", "cat4.webp"] },
'kirtimukha': { title: "Kirtimukha, the face of majesty", images: ["kirtimukha1.webp", "kirtimukha2.webp", "kirtimukha3.webp", "kirtimukha4.webp"] },
'stovegod': { title: "Stove God", images: ["stovegod1.webp", "stovegod2.webp", "stovegod3.webp", "stovegod4.webp"] },
'nehulay': { title: "Nehulay", images: ["nehulay1.webp", "nehulay2.webp", "nehulay3.webp", "nehulay4.webp"] },
'snow-lion': { title: "Snow Lion", images: ["snow-lion1.webp", "snow-lion2.webp", "snow-lion3.webp", "snow-lion4.webp"] }
};

// 2. 坐标分配器：匹配的键值也更新为了 .webp
const stoveHotspots = {
'stove1.webp': [
