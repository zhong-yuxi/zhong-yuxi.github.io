...
<div class="row align-items-center">
    ...
    <div class="col-md-7 px-md-5">
        <p class="text-start bio-text" style="font-family: 'Open Sans', sans-serif; font-size: 1.15rem; line-height: 1.8;">
            <strong>嗨，你可以叫我斯朗多吉，这是我的藏文名字！</strong><br>
        ...
        <div class="contact-info mt-4">
            ...
            <a href="/CV_Yuxi_Zhong.pdf" class="cv-link" style="font-family: 'MyJost', sans-serif; font-weight: bold; text-decoration: underline !important; letter-spacing: 0.05em; text-transform: uppercase;">下载简历</a>
        </div>
    </div>
</div>
</div>
